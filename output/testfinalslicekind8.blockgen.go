...
type TestFinalSliceKind8Reader[T1 blockgen.Number, S1 blockgen.Struct, S1Reader blockgen.Reader[S1, S1Writer], S1Writer blockgen.Writer[S1, S1Reader]] blockgen.BlockBytes

// Writer type extends the reader with mutable methods.
type TestFinalSliceKind8Writer[T1 blockgen.Number, S1 blockgen.Struct, S1Reader blockgen.Reader[S1, S1Writer], S1Writer blockgen.Writer[S1, S1Reader]] struct {
	TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer]
}

var fieldOffsetsOfTestFinalSliceKind8 blockgen.OffsetsMap

// BlockBytes returns access to the underlying byte slice.
func (v TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer]) BlockBytes() blockgen.BlockBytes {
...
func (v TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer]) IsZero() bool {
	var structSizeOfTestFinalSliceKind8 = blockgen.SizeFor[input.TestFinalSliceKind8[T1, S1]]()
	return blockgen.IsZero(v[:structSizeOfTestFinalSliceKind8])
}

// SetZero sets all underlying bytes to zero.
func (v TestFinalSliceKind8Writer[T1, S1, S1Reader, S1Writer]) SetZero() {
	var structSizeOfTestFinalSliceKind8 = blockgen.SizeFor[input.TestFinalSliceKind8[T1, S1]]()
	blockgen.SetZero(v.BlockBytes()[:structSizeOfTestFinalSliceKind8])
}
...
func TestFinalSliceKind8SliceFieldCap[T1 blockgen.Number, S1 blockgen.Struct](nbytes int) int {
	var structSizeOfTestFinalSliceKind8 = blockgen.SizeFor[input.TestFinalSliceKind8[T1, S1]]()
	var sliceElemSizeOfTestFinalSliceKind8 = blockgen.ElemSizeFor[input.TestMixedPair[uint16, S1]]()
...
func (v TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer]) FinalSliceLen() int {
	var fieldOffsetsOfTestFinalSliceKind8 = blockgen.OffsetsFor[input.TestFinalSliceKind8[T1, S1]](&fieldOffsetsOfTestFinalSliceKind8)
	var offset = fieldOffsetsOfTestFinalSliceKind8[0] + blockgen.OffsetOfSliceLen
...
func (v TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer]) FinalSliceCap() int {
	var fieldOffsetsOfTestFinalSliceKind8 = blockgen.OffsetsFor[input.TestFinalSliceKind8[T1, S1]](&fieldOffsetsOfTestFinalSliceKind8)
	var offset = fieldOffsetsOfTestFinalSliceKind8[0] + blockgen.OffsetOfSliceCap
	return blockgen.IntAt(v.BlockBytes(), offset)
}
...
func (v TestFinalSliceKind8Writer[T1, S1, S1Reader, S1Writer]) ResizeFinalSlice(size int) int {
	...
	var structSizeOfTestFinalSliceKind8 = blockgen.SizeFor[input.TestFinalSliceKind8[T1, S1]]()
	var elemSize = blockgen.ElemSizeFor[[]input.TestMixedPair[uint16, S1]]()
...
func (v TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer]) FinalSliceItemAt(i int) TestMixedPairReader[uint16, S1, S1Reader, S1Writer] {
	...
	return TestMixedPairReader[uint16, S1, S1Reader, S1Writer](v.BlockBytes()[offset:])
}
...
func NewTestFinalSliceKind8[T1 blockgen.Number, S1 blockgen.Struct, S1Reader blockgen.Reader[S1, S1Writer], S1Writer blockgen.Writer[S1, S1Reader]](block []byte) TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer] {
	var structSizeOfTestFinalSliceKind8 = blockgen.SizeFor[input.TestFinalSliceKind8[T1, S1]]()
	size := len(block)
...
func OpenTestFinalSliceKind8[T1 blockgen.Number, S1 blockgen.Struct, S1Reader blockgen.Reader[S1, S1Writer], S1Writer blockgen.Writer[S1, S1Reader]](block []byte) (TestFinalSliceKind8Reader[T1, S1, S1Reader, S1Writer], error) {
	var structSizeOfTestFinalSliceKind8 = blockgen.SizeFor[input.TestFinalSliceKind8[T1, S1]]()
	size := len(block)
	if size < structSizeOfTestFinalSliceKind8 {
